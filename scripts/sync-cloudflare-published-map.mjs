...
const privacySource = resolve(projectRoot, "privacy.html");
const privacyDestination = resolve(projectRoot, "cloudflare-upload/privacy.html");
const googleVerificationSource = resolve(projectRoot, "googlec0216c8e6774f44f.html");
const googleVerificationDestination = resolve(projectRoot, "cloudflare-upload/googlec0216c8e6774f44f.html");
...
await copyFile(googleVerificationSource, googleVerificationDestination);
